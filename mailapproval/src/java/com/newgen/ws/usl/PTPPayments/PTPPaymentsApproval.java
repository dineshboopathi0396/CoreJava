 ...
 ************************************************************************************************************************************************
 */
package com.newgen.ws.usl.PTPPayments;
...
@Path("PTPPayments")
public class PTPPaymentsApproval {
    ...
    public PTPPaymentsOutputXml postXml(PTPPaymentsInputXml ix) throws SQLException, ClassNotFoundException, IOException {
        CommonMethods call = new CommonMethods();
        PTPPaymentsOutputXml xml = new PTPPaymentsOutputXml();
                                ...
                                if (Curr_Workstep.equalsIgnoreCase("Approver")) {
                                    ...
                                    if (call.ReassignWorkitem(ProcessInstId, SystemUser,UserName)){// AssignedUser)) {
                                        ...
                                        if (Flag) {
                                            ...
                                            CommonMethods.mailTrigger_PTPPayments(ProcessInstId);
                                            }
                                            CommonMethods.GenLog("sMessage-->> " + sMessage,"T");
                                            sType = "S";
                                            call.InsertCommentsHistory(ProcessInstId, "Approval", "Approval", "Payments_Approver", Prev_Workstep, "Payments_Approver", tempusername, Comments);
